        ...
        <div className="rounded-[2rem] border border-white/70 bg-white/92 p-6 shadow-[0_24px_55px_rgba(15,36,22,0.08)] md:p-8 xl:p-10">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              { no: "02", t: "Pembayaran", d: "Transfer sesuai nominal biaya lalu unggah bukti pembayaran melalui portal." },
              { no: "03", t: "Input Atlet", d: "Setelah pembayaran disetujui, isi data atlet dan kategori sesuai kuota aktif." },
