...
function resolveSubmissionStatus(extraStatus: string, topUpStatus: string) {
  ...
  if (extraStatus === "OPEN" && topUpStatus === "APPROVED") {
    return {
      ...
      description: "Kuota tambahan sudah aktif. Peserta bisa lanjut ke Step 3 untuk mengisi slot baru tanpa mengubah kuota lama.",
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              ...
              <Link href="/dashboard/pendaftaran/atlet">
                <Button variant="secondary" className="w-full md:w-auto" disabled={!readyForStep3}>Lanjut Step 3</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
        ...
        <Card variant="soft">
          ...
          <CardContent className="space-y-3 text-sm text-gray-700">
            ...
            <div className="rounded-2xl border bg-white p-4">
              ...
              <div className="mt-1">Step 3 terbuka setelah top-up <b>APPROVED</b>.</div>
