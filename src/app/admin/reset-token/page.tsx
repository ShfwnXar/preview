  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="bg-white border rounded-xl p-6 shadow-sm">
        <h1 className="text-2xl font-extrabold text-gray-900">Buat Kode Reset Password</h1>
        <p className="text-gray-600 mt-2">
          Masukkan email peserta. Sistem akan membuat <b>kode 6 digit</b> berlaku 30 menit.
        </p>
      </div>
        ...
        <button
          onClick={() => {
            ...
            if (!res.ok) {
              ...
              setResult({ msg: "Token berhasil dibuat. Berikan kode ini ke peserta.", token: res.token, type: "ok" })
              setEmail("")
            }
          }}
